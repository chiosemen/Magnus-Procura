...
export type PolicyEvaluationReport = Readonly<{
    ...
    violations: ReadonlyArray<Readonly<{
        ruleId: string;
        status: PolicyStatus;
        reasons: ReadonlyArray<PolicyReason>;
    }>>;
...
export declare class PolicyRuleRegistrationError extends PolicyEngineError {
    readonly name: string;
}
export declare class PolicyFailClosedError extends PolicyEngineError {
    readonly name: string;
