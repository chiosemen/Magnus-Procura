...
import { packetRule } from './rules/packet.js';
...
export class PolicyEngine {
  ...
  public async evaluate(context: PolicyContext): Promise<PolicyEvaluationReport> {
    return evaluateRules({ rules: this.registry.list(), clock: this.clock, context });
  }
