...
export const insuranceRule: PolicyRule = {
  id: 'insurance.active',
  ...
  evaluate: (context: PolicyContext): PolicyResult => {
    ...
    if (raw == null) {
      return {
        ...
        timestamp: (context.input['evaluatedAt'] as string) || new Date().toISOString()
      };
    }
    ...
    const evaluatedAt = new Date(context.input['evaluatedAt'] as string);
